...
test-email:
	go test -count=1 ./libs/go/envx/... ./libs/go/emailx/... ./apps/smtp-relay/...
...
e2e-email-local:
	...
	go test -count=1 -tags=e2e_email_local -run TestSMTPRelayLocalE2E ./apps/smtp-relay/...
...
e2e-email-live:
	...
	go test -count=1 -tags=e2e_live_email -run TestSMTPRelayLiveResend ./apps/smtp-relay/...
