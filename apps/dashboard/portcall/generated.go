...
// Generated at: 2026-01-22T18:45:21Z
//
...
const BaseURL = "https://api.useportcall.com"
...
var Plans = struct {
	...
	DashboardFreeTier: "plan_fdc9220a194e45e1adf3540bd67cec32",
	DashboardProTier: "plan_eb5a79255bd64dccaa2b3f0695de9102",
}

// Plan ID constants
const (
	PlanDashboardFreeTier = "plan_fdc9220a194e45e1adf3540bd67cec32"
	PlanDashboardProTier = "plan_eb5a79255bd64dccaa2b3f0695de9102"
)
...
var AllPlans = []PlanMeta{
	{ID: "plan_fdc9220a194e45e1adf3540bd67cec32", Name: "Dashboard Free Tier", Status: "published", Currency: "USD", Interval: "month", IntervalCount: 1, TrialPeriodDays: 0, IsFree: true},
	{ID: "plan_eb5a79255bd64dccaa2b3f0695de9102", Name: "Dashboard Pro Tier", Status: "draft", Currency: "USD", Interval: "month", IntervalCount: 1, TrialPeriodDays: 0, IsFree: false},
}
...
func newCheckoutHelpers(sdk *portcallsdk.Client) *CheckoutHelpers {
	return &CheckoutHelpers{
		DashboardFreeTier: &CheckoutCreator{sdk: sdk, planID: "plan_fdc9220a194e45e1adf3540bd67cec32"},
		DashboardProTier: &CheckoutCreator{sdk: sdk, planID: "plan_eb5a79255bd64dccaa2b3f0695de9102"},
	}
}
