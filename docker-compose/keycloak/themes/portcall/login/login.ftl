<#-- Minimal, clean, greyscale login page for Keycloak -->
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Log in to Portcall</title>
  <style>
...
<body>
  ...
  <input tabindex="1" id="username" name="username" type="text" autofocus autocomplete="email" value="${(login.username!'')}" required />
      </div>
      <div class="form-group">
